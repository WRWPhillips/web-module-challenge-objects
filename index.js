...
const pizzaItem = createMenuItem('pizza', 7, 'lunch');
const nachoItem = createMenuItem('nachos', 14, 'lunch');
const potatoItem = createMenuItem('potato', 5, 'dinner');

console.log(pizzaItem);
console.log(nachoItem);
